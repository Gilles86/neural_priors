...
#SBATCH --output=/home/gdehol/logs/res_fmriprep_%A-alina.txt
#SBATCH --ntasks=1
...
singularity run -B /shares/zne.uzh/containers/templateflow:/opt/templateflow -B /shares/zne.uzh/gdehol/ds-neuralpriors:/data -B /scratch/gdehol:/workflow --cleanenv /shares/zne.uzh/containers/fmriprep-23.2.1 /data /data/derivatives/fmriprep participant --participant_label alina  --output-spaces MNI152NLin2009cAsym T1w fsaverage fsnative  --dummy-scans 4 --skip_bids_validation -w /workflow --no-submm-recon
