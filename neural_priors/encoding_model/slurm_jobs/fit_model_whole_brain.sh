#!/bin/bash
#SBATCH --job-name=fit_nprf2_whole_brain
#SBATCH --ntasks=1
#SBATCH --time=15:00
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=32G  # Request more memory
#SBATCH --output=/home/gdehol/logs/fit_nprf2_whole_brain_%A-%a.txt  # Default SLURM log
...
LOGFILE="/home/gdehol/logs/nprf2_fit_whole_brain_${SLURM_ARRAY_JOB_ID}-${SLURM_ARRAY_TASK_ID}_model-${MODEL}_${SMOOTHED_SUFFIX}_${FIT_RESPONSES_SUFFIX}_${CENSORED_SUFFIX}.txt"
