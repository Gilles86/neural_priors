...
LOGFILE="/home/gdehol/logs/nprf_fit_wb_sub-${PARTICIPANT_LABEL}_model-${MODEL}${SUFFIX}.txt"
scontrol update JobId=$SLURM_JOB_ID JobName="nprf_fit_wb_m${MODEL}_s${PARTICIPANT_LABEL}${SUFFIX}"
