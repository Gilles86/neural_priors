...
LOGFILE="/home/gdehol/logs/nprf_cv_sub-${PARTICIPANT_LABEL}_model-${MODEL}${SUFFIX}.txt"
scontrol update JobId=$SLURM_JOB_ID JobName="nprf_cv_m${MODEL}_s${PARTICIPANT_LABEL}${SUFFIX}"
